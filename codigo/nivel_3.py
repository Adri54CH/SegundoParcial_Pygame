def nivel_3(segundos):
    ...
    for i in range(14): #14
        ...
        balas = Bala(50 + i * 200,0,60,60)
        lista_balas.append(balas)

    for i in range(14):
        
            
        balas = Bala(ANCHO_VENTANA - 100,100 + i * 200,45,45)
    ...
    while flag_run:
        ...
        nivel_actual = fuente_score.render(f"NIVEL ACTUAL: 3",True,pygame.Color("white"))
