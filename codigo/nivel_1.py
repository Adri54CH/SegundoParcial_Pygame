def nivel_1(game_over=0):
    ...
    # print(character_main.animaciones)
    # print(character_main.caminar_down[0])
    while flag_run:
        ...
        if personaje.puntaje == 5:
            ...
            if estado == -1:
                ...
                cambiar_nivel(segundos,0,0,game_over)
